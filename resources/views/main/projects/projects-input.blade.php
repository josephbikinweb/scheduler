        ...
        >
            ...
            <div>
                ...
                <x-text-input
                    ...
                    type="text"
                    class="mt-1 block w-full"
                    :value="old('project_description', $project->project_description ?? '')"
                    required
                    autofocus
            ...
            <div>
                ...
                <x-text-input
                    ...
                    type="date"
                    class="mt-1 block w-full"
                    :value="old('deploy_date', $project->deploy_date ?? '')"
                    autofocus
            ...
            <div>
                ...
                <select
                    ...
                    name="status"
                >
                    <option value="{{old('status', $project?->status ?? '')}}">
                        @isset ($project)
                            {{ old('status', $project->status?->label()) }}
                        @else
                            {{ __('Choose one thing') }}
                        @endisset
                    </option>
            ...
            <div class="flex items-center gap-4">
                ...
                @if (session('status') === 'project-stored')
                    <p
                        x-data="{ show: true }"
                        x-show="show"
                        x-transition
